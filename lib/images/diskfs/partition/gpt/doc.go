...
//
// gpt.Table implements the Table interface in github.com/768bit/promethium/lib/images/diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/768bit/promethium/lib/images/diskfs package,
