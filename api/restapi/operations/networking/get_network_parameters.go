...
// GetNetworkParams contains all the bound params for the get network operation
...
//
// To ensure default values, the struct must have been initialized with NewGetNetworkParams() beforehand.
func (o *GetNetworkParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetNetworkParams) bindNetworkID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
