...
// WithImageConfig adds the imageConfig to the create image params
func (o *CreateImageParams) WithImageConfig(imageConfig *models.NewImage) *CreateImageParams {
	o.SetImageConfig(imageConfig)
	return o
}

// SetImageConfig adds the imageConfig to the create image params
func (o *CreateImageParams) SetImageConfig(imageConfig *models.NewImage) {
...
func (o *CreateImageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ImageConfig != nil {
		if err := r.SetBodyParam(o.ImageConfig); err != nil {
			return err
		}
	}
