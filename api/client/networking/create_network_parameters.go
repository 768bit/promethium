...
// WithNetConfig adds the netConfig to the create network params
func (o *CreateNetworkParams) WithNetConfig(netConfig *models.NewNetwork) *CreateNetworkParams {
	o.SetNetConfig(netConfig)
	return o
}

// SetNetConfig adds the netConfig to the create network params
func (o *CreateNetworkParams) SetNetConfig(netConfig *models.NewNetwork) {
...
func (o *CreateNetworkParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.NetConfig != nil {
		if err := r.SetBodyParam(o.NetConfig); err != nil {
			return err
		}
	}
